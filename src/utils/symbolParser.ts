 ...
 */
export function parseTypeScriptSymbols(content: string, filePath: string): Symbol[] {
 ...
 */
export function parsePythonSymbols(content: string, filePath: string): Symbol[] {
 const symbols: Symbol[] = [];
 ...
 */
export function parseTypeScriptExports(content: string): string[] {
 ...
 */
export function parseSymbols(content: string, language: string, filePath: string): Symbol[] {
 switch (language) {
 case 'typescript':
 case 'javascript':
 ...
 */
export function parseExports(content: string, language: string): string[] {
 switch (language) {
 case 'typescript':
 case 'javascript':
