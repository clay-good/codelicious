...
describe('CacheManager', () => {
 ...
 cacheManager = new CacheManager(mockContext, mockConfigManager);
 ...
 const disabledCache = new CacheManager(mockContext, disabledConfigManager);
 ...
 const retrieved = await cacheManager.get<typeof obj>('obj');
 ...
 const retrieved = await cacheManager.get<typeof arr>('arr');
 ...
 const retrieved = await cacheManager.get<typeof largeObj>('large');
