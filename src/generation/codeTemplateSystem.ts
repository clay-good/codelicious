...
export class CodeTemplateSystem {
 ...
 */
 ...
 t.category === category && (!language || t.language === language)
 );
 }
 ...
 */
 private applyDefaults(template: Template, context: TemplateContext): TemplateContext {
 ...
 */
 ...
 return array.map((item: any) => { // Template array item structure
