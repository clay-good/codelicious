...
const logger = createLogger('ComprehensiveTestGenerator');
...
export class ComprehensiveTestGenerator {
 private mutationEngine?: MutationTestingEngine;
 ...
 this.mutationEngine = new MutationTestingEngine(executionEngine, orchestrator, workspaceRoot);
 }
 }
 ...
 */
 private async generateUnitTests(request: TestGenerationRequest): Promise<GeneratedTest> {
 ...
 */
 private async generateIntegrationTests(request: TestGenerationRequest): Promise<GeneratedTest> {
 ...
 * Generate E2E tests
 */
 private async generateE2ETests(request: TestGenerationRequest): Promise<GeneratedTest> {
 ...
 */
 private getUnitTestSystemPrompt(request: TestGenerationRequest): string {
 ...
 */
 private getIntegrationTestSystemPrompt(request: TestGenerationRequest): string {
 ...
 */
 private getE2ETestSystemPrompt(request: TestGenerationRequest): string {
 ...
 */
 private getFrameworkSpecificGuidelines(request: TestGenerationRequest): string {
 ...
 */
 private buildUnitTestPrompt(request: TestGenerationRequest): string {
 ...
 */
 private buildIntegrationTestPrompt(request: TestGenerationRequest): string {
 ...
 */
 private buildE2ETestPrompt(request: TestGenerationRequest): string {
 ...
 */
 private extractEdgeCases(response: string): string[] {
 ...
 */
 private calculateQuality(tests: GeneratedTest[], request: TestGenerationRequest): TestQualityReport {
 let score = 100;
 ...
 * Estimate coverage
 */
 private estimateCoverage(tests: GeneratedTest[], request: TestGenerationRequest): CoverageEstimate {
 const unitTest = tests.find(t => t.type === 'unit');
