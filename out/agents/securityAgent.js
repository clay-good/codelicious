...
exports.SecurityReviewAgent = void 0;
const baseAgent_1 = require("./baseAgent");
const types_1 = require("./types");
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('SecurityAgent');
class SecurityReviewAgent extends baseAgent_1.BaseAgent {
    constructor(orchestrator, config = {}) {
        super(types_1.AgentRole.SECURITY_REVIEWER, orchestrator, {
...
Be thorough but practical. Focus on real security risks and significant quality issues.`;
    ...
    async parseResponse(response, context) {
        try {
            const data = this.extractJSON(response); // Security agent response structure
            ...
            const qualityIssues = (data.qualityIssues || []).map((q) => ({
    ...
    */
    async quickSecurityCheck(code, language) {
        const issues = [];
...
exports.SecurityReviewAgent = SecurityReviewAgent;
