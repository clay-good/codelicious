...
describe('SessionManager', () => {
    ...
    beforeEach(() => {
        ...
        sessionManager = new sessionManager_1.SessionManager(mockContext);
    });
    afterEach(async () => {
    ...
    describe('listSessions', () => {
        it('should list all sessions', async () => {
            ...
            fs.existsSync.mockReturnValue(true);
            fs.readdirSync.mockReturnValue(['session_1.json', 'session_2.json']);
            fs.readFileSync
    ...
    describe('searchSessions', () => {
        it('should search sessions by query', async () => {
            ...
            fs.existsSync.mockReturnValue(true);
            fs.readdirSync.mockReturnValue(['test_session.json']);
            fs.readFileSync.mockReturnValue(JSON.stringify(mockSession));
