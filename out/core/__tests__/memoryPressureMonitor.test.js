...
const memoryPressureMonitor_1 = require("../memoryPressureMonitor");
describe('MemoryPressureMonitor', () => {
    let monitor;
    beforeEach(() => {
        monitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
    ...
    describe('initialization', () => {
        it('should initialize with default config', () => {
            const defaultMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor();
            expect(defaultMonitor).toBeDefined();
        });
        it('should initialize with custom config', () => {
            const customMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
    ...
    describe('getStats', () => {
        it('should return statistics', () => {
            ...
            expect(stats.currentLevel).toBe(memoryPressureMonitor_1.MemoryPressureLevel.NORMAL);
    ...
    describe('edge cases', () => {
        it('should handle zero thresholds', () => {
            const zeroMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
                warningThreshold: 0,
                criticalThreshold: 0,
                maxHeapSize: 1
            });
        ...
        it('should handle very high thresholds', () => {
            const highMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
    ...
    describe('callbacks', () => {
        it('should accept callback configuration', () => {
            ...
            const callbackMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
        ...
        it('should work without callbacks', () => {
            const noCallbackMonitor = new memoryPressureMonitor_1.MemoryPressureMonitor({
                warningThreshold: 100,
                criticalThreshold: 150,
                maxHeapSize: 200
            });
...
//# sourceMappingURL=memoryPressureMonitor.test.js.map