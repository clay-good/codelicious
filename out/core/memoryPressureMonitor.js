...
exports.MemoryPressureMonitor = exports.MemoryPressureLevel = void 0;
const os = __importStar(require("os"));
const vscode = __importStar(require("vscode"));
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('MemoryPressureMonitor');
...
})(MemoryPressureLevel || (exports.MemoryPressureLevel = MemoryPressureLevel = {}));
/**
 * Memory Pressure Monitor
 */
class MemoryPressureMonitor {
    ...
    */
    handleLevelChange(previousLevel, newLevel, usage) {
        ...
        switch (newLevel) {
            case MemoryPressureLevel.CRITICAL:
                ...
                vscode.window.showWarningMessage(`High memory usage: ${usage.heapUsed.toFixed(0)}MB. Cleaning up...`);
                break;
