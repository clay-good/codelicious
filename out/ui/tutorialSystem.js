...
• Recommendations`,
    ...
    */
    async completeTutorial() {
        ...
        this.saveProgress();
        vscode.window.showInformationMessage(` Congratulations! You've completed "${this.currentTutorial.title}"!`, 'Start Another Tutorial', 'Close').then(action => {
    ...
    */
    async skipTutorial() {
        const confirm = await vscode.window.showWarningMessage('Are you sure you want to skip this tutorial? Your progress will be saved.', 'Yes, Skip', 'No, Continue');
        if (confirm === 'Yes, Skip') {
            this.currentTutorial = undefined;
            this.currentStepIndex = 0;
        }
    ...
    */
    loadProgress() {
        const completed = this.context.globalState.get('codelicious.completedTutorials', []);
        this.completedTutorials = new Set(completed);
        const progress = this.context.globalState.get('codelicious.tutorialProgress', {});
...
//# sourceMappingURL=tutorialSystem.js.map