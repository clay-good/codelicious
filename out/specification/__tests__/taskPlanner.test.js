...
describe('TaskPlanner', () => {
    ...
    beforeEach(() => {
        planner = new taskPlanner_1.TaskPlanner(mockWorkspaceRoot);
    });
    const createMockSpec = (tasks) => ({
        title: 'Test Spec',
    ...
    describe('generateWarnings', () => {
        ...
        it('should warn about critical constraints', async () => {
            ...
            spec.constraints = [
                {
                    id: 'constraint-1',
                    type: specificationParser_1.ConstraintType.TIME,
    ...
    describe('phase naming', () => {
        it('should name phases based on task types', async () => {
            const spec = createMockSpec([
                { id: 'task-1', type: specificationParser_1.TaskType.CREATE },
                { id: 'task-2', type: specificationParser_1.TaskType.CREATE },
                { id: 'task-3', type: specificationParser_1.TaskType.TEST, dependencies: ['task-1', 'task-2'] }
            ]);
            const plan = await planner.plan(spec);
