...
- Use proper authentication`;
    ...
    */
    async enforceQualityGates(code, request) {
        const issues = [];
        const improvements = [];
        let quality = 100;
    ...
    * Apply quality fixes
    */
    async applyQualityFixes(code, issues, request) {
...
exports.EnhancedCodeGenerator = EnhancedCodeGenerator;
//# sourceMappingURL=enhancedCodeGenerator.js.map