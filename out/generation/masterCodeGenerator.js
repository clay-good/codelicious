...
exports.MasterCodeGenerator = void 0;
const enhancedContextGatherer_1 = require("./enhancedContextGatherer");
const codeTemplateSystem_1 = require("./codeTemplateSystem");
const advancedCodeAnalyzer_1 = require("./advancedCodeAnalyzer");
const bestPracticesEngine_1 = require("./bestPracticesEngine");
const multiPassRefinement_1 = require("./multiPassRefinement");
const codeValidationPipeline_1 = require("./codeValidationPipeline");
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('MasterCodeGenerator');
class MasterCodeGenerator {
    constructor() {
        this.contextGatherer = new enhancedContextGatherer_1.EnhancedContextGatherer();
        this.templateSystem = new codeTemplateSystem_1.CodeTemplateSystem();
        ...
        this.refinement = new multiPassRefinement_1.MultiPassRefinement();
        this.validation = new codeValidationPipeline_1.CodeValidationPipeline();
    }
    /**
    ...
    */
    async generate(request) {
        ...
        try {
            ...
            const context = await this.contextGatherer.gather(request.workspaceRoot, request.filePath);
    ...
    */
    async generateInitialCode(request, context, options) {
        ...
        if (options.useTemplates) {
            ...
            if (template && typeof template === 'object' && template !== null && 'id' in template) {
                ...
                return this.templateSystem.generate(template.id, templateContext);
            }
        }
    ...
    */
    findSuitableTemplate(request, context) {
    ...
    */
    buildTemplateContext(request, context) {
    ...
    */
    async generateFromScratch(request, context) {
    ...
    */
    buildProductionPrompt(request, context) {
...
Generate ONLY the code, no explanations.`;
    ...
    */
    generateTypeScriptCode(request, context) {
...
`;
    ...
    */
    generatePythonCode(request, context) {
        const className = this.extractClassName(request.description) || 'GeneratedService';
        return `"""
${request.description}
...
`;
    ...
    */
    generateJavaScriptCode(request, context) {
        const className = this.extractClassName(request.description) || 'GeneratedService';
        return `/**
 * ${request.description}
 *
...
`;
    ...
    * Generate tests
    */
    async generateTests(code, request, context) {
...
`;
    ...
    */
    async generateDocumentation(code, request, context) {
...
`;
    ...
    */
    createQualityReport(code, language, validationResult) {
...
exports.MasterCodeGenerator = MasterCodeGenerator;
//# sourceMappingURL=masterCodeGenerator.js.map