...
describe('GeminiAdapter', () => {
    ...
    beforeEach(() => {
        ...
        adapter = new geminiAdapter_1.GeminiAdapter({ apiKey: mockApiKey });
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('initialization', () => {
        it('should create adapter with API key', () => {
            ...
            expect(adapter.getProvider()).toBe(types_1.ModelProvider.GEMINI);
        });
        it('should create adapter with custom base URL', () => {
            const customAdapter = new geminiAdapter_1.GeminiAdapter({
                apiKey: mockApiKey,
    ...
    describe('sendRequest', () => {
        ...
        it('should handle request with temperature', async () => {
            ...
            expect(mockAxiosInstance.post).toHaveBeenCalledWith(expect.stringContaining('gemini-1.5-pro'), expect.objectContaining({
