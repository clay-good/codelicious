...
describe('ClaudeAdapter', () => {
    ...
    beforeEach(() => {
        ...
        adapter = new claudeAdapter_1.ClaudeAdapter({ apiKey: mockApiKey });
    });
    afterEach(() => {
        jest.clearAllMocks();
    });
    describe('initialization', () => {
        it('should create adapter with API key', () => {
            ...
            expect(adapter.getProvider()).toBe(types_1.ModelProvider.CLAUDE);
        });
        it('should create adapter with custom base URL', () => {
            const customAdapter = new claudeAdapter_1.ClaudeAdapter({
                apiKey: mockApiKey,
    ...
    describe('sendRequest', () => {
        ...
        it('should handle request with temperature', async () => {
            ...
            expect(mockAxiosInstance.post).toHaveBeenCalledWith('/messages', expect.objectContaining({
                temperature: 0.7
            }));
        });
