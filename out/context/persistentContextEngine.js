...
exports.PersistentContextEngine = exports.DependencyMapper = exports.ArchitectureAnalyzer = exports.PersistentIndexStore = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
const fs = __importStar(require("fs/promises"));
const ts = __importStar(require("typescript"));
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('PersistentContextEngine');
// ============================================================================
...
exports.PersistentIndexStore = PersistentIndexStore;
// ============================================================================
...
class ArchitectureAnalyzer {
    ...
    */
    ...
    detectDesignPatterns(files) {
        const patterns = [];
        // Factory pattern
        const factories = files.filter(f => f.path.includes('factory') ||
        ...
        // Singleton pattern
        const singletons = files.filter(f => f.symbols.some(s => s.name.toLowerCase().includes('singleton') ||
...
class PersistentContextEngine {
    constructor(context, vectorStore, embeddingManager) {
        this.context = context;
    ...
    */
    async buildPersistentIndex(workspaceRoot) {
    ...
    */
    async scanCodebase(workspaceRoot) {
        const files = [];
    ...
    */
    async assembleContext(files, options) {
        let totalTokens = 0;
        const relevantFiles = [];
        const allPatterns = [];
...
exports.PersistentContextEngine = PersistentContextEngine;
//# sourceMappingURL=persistentContextEngine.js.map