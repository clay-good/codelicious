...
exports.AnalyticsViewProvider = void 0;
const vscode = __importStar(require("vscode"));
class AnalyticsViewProvider {
    constructor(_extensionUri, analyticsManager) {
    ...
    */
    async clearData() {
        const confirm = await vscode.window.showWarningMessage('Are you sure you want to clear all analytics data?', { modal: true }, 'Clear');
        if (confirm === 'Clear') {
...
exports.AnalyticsViewProvider = AnalyticsViewProvider;
AnalyticsViewProvider.viewType = 'codelicious.analyticsView';
//# sourceMappingURL=analyticsViewProvider.js.map