...
exports.IterativeRefinementEngine = void 0;
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('IterativeRefinementEngine');
class IterativeRefinementEngine {
    constructor(orchestrator, validator, executionEngine, workspaceRoot) {
    ...
    */
    async refineUntilPerfect(generatedCode, requirements, options = {}) {
        ...
        while (iteration < opts.maxIterations) {
            ...
            const validation = await this.validator.validate(currentCode.generatedFiles, [], // Tests validated separately
            requirements);
            ...
            const validationAfter = await this.validator.validate(currentCode.generatedFiles, [], requirements);
    ...
    */
    async analyzeIssues(validation, code, options) {
        const issues = [];
    ...
    * Analyze compilation errors
    */
    async analyzeCompilationErrors(validation, code) {
        const issues = [];
    ...
    * Analyze test failures
    */
    async analyzeTestFailures(validation, code) {
        const issues = [];
    ...
    * Analyze linting issues
    */
    async analyzeLintingIssues(code) {
    ...
    * Analyze logic errors
    */
    async analyzeLogicErrors(validation, code) {
    ...
    */
    async generateFixes(issues, code) {
        const fixes = [];
    ...
    */
    async generateFixesForFile(file, issues, code) {
...
Provide the fixed code. Only output the complete fixed code, no explanations.`;
    ...
    */
    parseFixesFromResponse(response, file) {
...
exports.IterativeRefinementEngine = IterativeRefinementEngine;
//# sourceMappingURL=iterativeRefinementEngine.js.map