...
class MultiLanguageSupport {
    ...
    */
    async compile(file, workspaceRoot) {
    ...
    */
    async runTests(file, workspaceRoot) {
        const language = this.detectLanguage(file.filePath);
        const config = this.languageConfigs.get(language);
        if (!config) {
    ...
    */
    async installDependencies(language, packages, workspaceRoot) {
        const config = this.languageConfigs.get(language);
    ...
    */
    async format(file, workspaceRoot) {
        const language = this.detectLanguage(file.filePath);
        const config = this.languageConfigs.get(language);
