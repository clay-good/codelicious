...
describe('ProjectStateTracker', () => {
    ...
    beforeEach(() => {
        ...
        tracker = new projectState_1.ProjectStateTracker(workspaceRoot, projectName, 50);
    });
    afterEach(() => {
        tracker.dispose();
    });
    describe('Initialization', () => {
        ...
        it('should generate unique project ID', () => {
            const tracker1 = new projectState_1.ProjectStateTracker(workspaceRoot, projectName);
            const tracker2 = new projectState_1.ProjectStateTracker(workspaceRoot, projectName);
    ...
    describe('State Persistence', () => {
        it('should save state to disk', async () => {
            ...
            expect(mockFs.mkdirSync).toHaveBeenCalledWith(path.dirname(stateFilePath), { recursive: true });
            expect(mockFs.writeFileSync).toHaveBeenCalledWith(stateFilePath, expect.any(String), 'utf8');
        });
    ...
    describe('File Tracking', () => {
        it('should track file created', () => {
            ...
            const state = tracker.getState();
            expect(state.filesCreated).toContainEqual(expect.objectContaining({
                path: 'src/main.ts',
                language: 'typescript',
                size: 1024
            }));
        ...
        it('should track file modified', () => {
            ...
            const state = tracker.getState();
            expect(state.filesModified).toContainEqual(expect.objectContaining({
                path: 'src/main.ts',
                size: 2048
            }));
        });
...
//# sourceMappingURL=projectState.test.js.map