...
exports.PatternEmbeddingService = void 0;
class PatternEmbeddingService {
    constructor(embeddingManager, cacheManager) {
    ...
    */
    async generatePatternEmbedding(pattern, options = {}) {
        ...
        const combinedEmbedding = this.combineEmbeddings(codeEmbedding, structureEmbedding, semanticEmbedding);
        // Assess quality
    ...
    */
    async generateBatchEmbeddings(patterns, options = {}) {
        ...
        for (let i = 0; i < patterns.length; i += batchSize) {
            ...
            const batchPromises = batch.map(pattern => this.generatePatternEmbedding(pattern, options));
    ...
    */
    async findSimilarPatterns(query, patterns, options = {}) {
    ...
    */
    async optimizeEmbeddings(patterns) {
    ...
    */
    extractSemanticMeaning(pattern) {
        const parts = [];
    ...
    */
    combineEmbeddings(codeEmbedding, structureEmbedding, semanticEmbedding) {
    ...
    */
    selectEmbedding(multiLevel, type) {
        switch (type) {
            case 'code':
    ...
    */
    assessEmbeddingQuality(pattern, embedding) {
        let quality = 0.8;
...
exports.PatternEmbeddingService = PatternEmbeddingService;
//# sourceMappingURL=patternEmbeddingService.js.map