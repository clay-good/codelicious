...
exports.PRDescriptionGenerator = exports.PRTemplate = void 0;
const logger_1 = require("../utils/logger");
const logger = (0, logger_1.createLogger)('PRDescriptionGenerator');
var PRTemplate;
(function (PRTemplate) {
    PRTemplate["STANDARD"] = "standard";
    PRTemplate["FEATURE"] = "feature";
    PRTemplate["BUGFIX"] = "bugfix";
    PRTemplate["HOTFIX"] = "hotfix";
    PRTemplate["REFACTOR"] = "refactor";
    PRTemplate["DOCS"] = "docs";
})(PRTemplate || (exports.PRTemplate = PRTemplate = {}));
class PRDescriptionGenerator {
    ...
    */
    async generatePRDescription(options = {}) {
        const { baseBranch = 'main', includeChecklist = true, includeBreakingChanges = true, includeTestingNotes = true, template = PRTemplate.STANDARD } = options;
        // Get current branch
        ...
        const prompt = this.buildPrompt(currentBranch, baseBranch, analysis, template, includeChecklist, includeBreakingChanges, includeTestingNotes);
    ...
    */
    analyzeChanges(commits, diffs) {
        ...
        analysis.hasBreakingChanges = commits.some(c => c.message.toLowerCase().includes('breaking') ||
    ...
    */
    buildPrompt(currentBranch, baseBranch, analysis, template, includeChecklist, includeBreakingChanges, includeTestingNotes) {
    ...
    */
    parsePRDescription(response, template, includeChecklist) {
...
exports.PRDescriptionGenerator = PRDescriptionGenerator;
//# sourceMappingURL=prDescriptionGenerator.js.map