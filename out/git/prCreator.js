...
class PRCreator {
    ...
    */
    async createFeatureBranch(featureName, options) {
        try {
    ...
    * Determine branch strategy
    */
    determineBranchStrategy(featureName) {
    ...
    */
    determineCommitType(analysis) {
        ...
        const hasTests = analysis.files.some((f) => f.path.includes('test'));
        const hasDocs = analysis.files.some((f) => f.path.includes('README') || f.path.includes('.md'));
    ...
    */
    generateCommitSubject(analysis) {
